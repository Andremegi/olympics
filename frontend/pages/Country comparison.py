...
url_server ='http://46.62.198.80:8000/best_countries?'
...
if buton :
    ...
    if response.status_code != 204:
        ...
        url_country_list_server = 'http://46.62.198.80:8000/list_country_names?'
        ...
        sorted_non_spaces[f'Top {number_countries} countries'] = requests.get(url_country_list_server, params = {'list': sorted_non_spaces['best_countries'].to_list()}).json()['list']
        ...
        sorted_non_spaces[f'Ratio medal/athletes'] = requests.get(url_country_list_server, params = {'list': sorted_non_spaces['medal/athletes best countries'].to_list()}).json()['list']
