...
url_server ='http://46.62.198.80:8000/country_evolution'
...
url_countrynames_server = 'http://46.62.198.80:8000/country_to_noc?'

param = requests.get(url_countrynames_server, params = {'argument':country}).json()['name']
...
if response.status_code != 204:
    ...
    if country_ev_df.empty:
        ...
        if buton2:
            ...
            url3_server ='http://46.62.198.80:8000/deeper_country_evolution?'
            params3= {'year':int(year),
                    'country_noc': param}
            response3 = requests.get(url3_server,params=params3)
